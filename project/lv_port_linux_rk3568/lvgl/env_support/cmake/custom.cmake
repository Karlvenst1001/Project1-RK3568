...
target_include_directories(lvgl PUBLIC ${LVGL_ROOT_DIR}/../lib/freetype/include/freetype2)
target_include_directories(lvgl PUBLIC ${LVGL_ROOT_DIR}/../lib/libpng/include)
target_include_directories(lvgl PUBLIC ${LVGL_ROOT_DIR}/../lib/zlib/include)
target_link_libraries(lvgl PUBLIC ${LVGL_ROOT_DIR}/../lib/freetype/lib/libfreetype.so)
target_link_libraries(lvgl PUBLIC ${LVGL_ROOT_DIR}/../lib/libpng/lib/libpng16.so)
target_link_libraries(lvgl PUBLIC ${LVGL_ROOT_DIR}/../lib/zlib/lib/libz.so)
