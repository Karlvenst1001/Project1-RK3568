...
///////////////////// VARIABLES ////////////////////
lv_anim_t * pangxie_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * zhangyu_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * fish1_Animation(lv_obj_t * TargetObject, int delay);
lv_anim_t * fish2_Animation(lv_obj_t * TargetObject, int delay);
...
lv_anim_t * pangxie_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    PropertyAnimation_0_user_data->imgset = (lv_img_dsc_t **)ui_init;
    PropertyAnimation_0_user_data->imgset_size = sizeof(ui_init) / (sizeof(lv_img_dsc_t *));
...
lv_anim_t * fish2_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_user_data(&PropertyAnimation_0, PropertyAnimation_0_user_data);
    lv_anim_set_custom_exec_cb(&PropertyAnimation_0, _ui_anim_callback_set_x);
    lv_anim_set_values(&PropertyAnimation_0, 1500, 0);
    lv_anim_set_path_cb(&PropertyAnimation_0, lv_anim_path_ease_out);
    lv_anim_set_delay(&PropertyAnimation_0, delay + 0);
    lv_anim_set_deleted_cb(&PropertyAnimation_0, _ui_anim_callback_free_user_data);
    lv_anim_set_playback_time(&PropertyAnimation_0, 0);
